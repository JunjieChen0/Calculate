...
function ensureModal() {
  ...
  modalOverlay.innerHTML = "<div class=\"modal-box\"><p class=\"modal-message\"></p><div class=\"modal-actions\"><button class=\"modal-btn modal-cancel\">\u53d6\u6d88</button><button class=\"modal-btn modal-confirm\">\u786e\u5b9a</button></div></div>";
